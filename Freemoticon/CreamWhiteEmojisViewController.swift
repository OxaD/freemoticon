//
//  CreamWhiteEmojisViewController.swift
//  Freemoticon
//
...
class CreamWhiteEmojisViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    
    let reuseIdentifier = "creamWhiteEmojisCell" // also enter this string as the cell identifier in the storyboard
    var emoticons = ["👦🏼","👧🏼","👨🏼","👩🏼","👴🏼","👵🏼","👶🏼","👱🏼","👮🏼","👲🏼","👳🏼","👷🏼","👸🏼","💂🏼","🎅🏼","👼🏼","💆🏼","💇🏼",
                     "👰🏼","🙍🏼","🙎🏼","🙅🏼","🙆🏼","💁🏼","🙋🏼","🙇🏼","🙌🏼","🙏🏼","🚶🏼","🏃🏼","💃🏼","💪🏼","👈🏼","👉🏼","☝️🏼","👆🏼",
                     "🖕🏼","👇🏼","✌️🏼","🖖🏼","🤘🏼","🖐🏼","✊🏼","✋🏼","👊🏼","👌🏼","👍🏼","👎🏼","👋🏼","👏🏼","👐🏼","✍🏼","💅🏼","👂🏼",
                     "👃🏼","🚣🏼","🛀🏼","🏄🏼","🏇","🏼","🏊🏼","⛹🏼","🏋🏼","🚴🏼","🚵🏼"]
