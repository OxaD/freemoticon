//
//  PaleEmojisViewController.swift
//  Freemoticon
//
...
class PaleEmojisViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {

    let reuseIdentifier = "paleEmojisCell" // also enter this string as the cell identifier in the storyboard
    var emoticons = ["👦🏻","👧🏻","👨🏻","👩🏻","👴🏻","👵🏻","👶🏻","👱🏻","👮🏻","👲🏻","👳🏻","👷🏻","👸🏻","💂🏻","🎅🏻","👼🏻","💆🏻","💇🏻",
                     "👰🏻","🙍🏻","🙎🏻","🙅🏻","🙆🏻","💁🏻","🙋🏻","🙇🏻","🙌🏻","🙏🏻","🚶🏻","🏃🏻","💃🏻","💪🏻","👈🏻","👉🏻","☝️🏻","👆🏻",
                     "🖕🏻","👇🏻","✌️🏻","🖖🏻","🤘🏻","🖐🏻","✊🏻","✋🏻","👊🏻","👌🏻","👍🏻","👎🏻","👋🏻","👏🏻","👐🏻","✍🏻","💅🏻","👂🏻",
                     "👃🏻","🚣🏻","🛀🏻","🏄🏻","🏇","🏻","🏊🏻","⛹🏻","🏋🏻","🚴🏻","🚵🏻"]
